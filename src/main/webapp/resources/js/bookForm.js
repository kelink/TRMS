function back(id) {
	...
	document.getElementById("iframe" + id).setAttribute("src",
			"/trms/room/calendar?room_ID=" + id);
...
function isEmpty() {
	...
	if (department_ID == "" || team_ID == "" || begin_time == ""
			|| end_time == "" || email == "") {
		...
		var a = document.getElementById("floatTicket");
		var b = document.getElementById("cover");
		// document.getElementById("iframe"+id).setAttribute("src","/trms/room/calendar?room_ID="+id);
		a.setAttribute("class", "");
		b.setAttribute("class", "");
		scrollTo(0, 0);
