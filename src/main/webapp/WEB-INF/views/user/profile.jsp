			  	         ...
			  	         <div id="chPwdPanel">
                             ...
                             <div>
                                 <form action="#" method="post" onsubmit="return checkSubmit();">
                                     ...
                                     <input class="chPwdInput" type="password" name="oldPassword" required id="oldPassword"  onBlur="checkOldPassword()" >
                                     <div class="chPwdLabel">
                                         New password
                                     </div>
                                     <input class="chPwdInput"type="password" name="newPassword" required id="newPassword">
                                     <div class="chPwdLabel">
                                         Confirm new password
                                     </div type="password">
                                     <input class="chPwdInput"type="password" name="newPassword2" required id="newPassword2" onBlur="checkTwicePassword()">
